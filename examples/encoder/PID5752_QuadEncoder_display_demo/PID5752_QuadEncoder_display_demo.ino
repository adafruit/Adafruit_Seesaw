/*
 * This is a demo for a ESP32-S2 TFT Feather connected to a quad rotary encoder breakout
...
// we have loooots of PSRAM so lets use a GFX canvas for flicker-free graphics!
