...
/*
 * This example shows how read the potentiometer on two I2C QT Slide
 * Potentiometers and make the NeoPixels change too!
 */
...
void setup() {
  ...
  if (!seesaw1.begin(DEFAULT_I2C_ADDR) ||
      !seesaw2.begin(DEFAULT_I2C_ADDR + 1)) {
  ...
  if (!pixels1.begin(DEFAULT_I2C_ADDR) ||
      !pixels2.begin(DEFAULT_I2C_ADDR + 1)) {
